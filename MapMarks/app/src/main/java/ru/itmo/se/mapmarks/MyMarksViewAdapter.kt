...
class MyMarksViewAdapter(val allMarks: List<Mark>, val context: Context): RecyclerView.Adapter<MyMarksViewAdapter.MyMarksViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyMarksViewHolder, position: Int) {
        val currentMark = allMarks[position]
